          ...
          <div className="flex-1 flex flex-col justify-between p-4 xl:p-16 max-w-4xl">
            ...
            <div className="flex-1 flex items-center">
              <div className="max-w-3xl">
                <h1
                  key={currentSlide}
                  className="text-3xl xl:text-5xl 2xl:text-7xl font-light text-white leading-[1.1] mb-6 xl:mb-8 animate-in fade-in slide-in-from-right-4 duration-1000"
                >
                ...
                <p
                  ...
                  className="text-lg xl:text-xl text-gray-300 leading-relaxed max-w-2xl animate-in fade-in slide-in-from-right-4 duration-1000 delay-200"
                >
        ...
        <div className="lg:hidden flex-1 flex flex-col justify-between p-4">
          ...
          <div className="flex-1 flex items-center">
            <div className="w-full">
              <h1
                key={currentSlide}
                className="text-2xl sm:text-3xl md:text-4xl font-light text-white leading-[1.1] mb-6 animate-in fade-in slide-in-from-right-4 duration-1000"
              >
                {currentSlideData.title}
              </h1>
              ...
              <p
                key={`${currentSlide}-subtitle`}
                className="text-base sm:text-lg text-gray-300 leading-relaxed animate-in fade-in slide-in-from-right-4 duration-1000 delay-200"
              >
                {currentSlideData.subtitle}
              </p>
            </div>
