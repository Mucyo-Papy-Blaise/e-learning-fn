  ...
  if (!lessonId) {
    return (
      <div className="max-w-3xl mx-auto bg-white shadow rounded-lg p-6">
        <h1 className="text-xl font-semibold mb-2">Missing lesson ID parameter.</h1>
        <p className="text-gray-600 mb-4">Expected URL format: <code>/instructor/resources?lesson_id=YOUR_LESSON_ID</code></p>
